...
<body>
				...
				<div class="auth-box ">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Adio Admin</h1>
							<p>Login Page</p>
						</div>
					</div>
	...
	<!-- END WRAPPER -->
        <script type="text/javascript">
			var mainRoot = "<?php echo FULLROOT; ?>";
			var roott = "<?php echo ROOT; ?>";
		</script>
